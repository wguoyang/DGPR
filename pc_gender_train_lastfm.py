...
def clf_gender_all_pre(model_id,epoch_run,users_embs,user_gender,factor_num):
    ##movieLens-1M
    ...
    val_loader = DataLoader(val_dataset_loss,
            batch_size=val_count, shuffle=False, num_workers=0)
